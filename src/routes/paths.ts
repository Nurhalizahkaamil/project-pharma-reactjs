...
export const rootPaths = {
  ...
  inventories: 'manage-inventory/inventories',
  createInventory: 'manage-inventory/inventories/create',
  updateInventory: 'manage-inventory/inventories/update/:id',
  stockopname: 'manage-inventory/stockopname',
  createStockopname: 'manage-inventory/stockopname/create',
  updateStockopname: 'manage-inventory/stockopname/update/:id',
  warehouse: 'master-data/warehouse',
  createWarehouse: 'master-data/warehouse/create',
  updateWarehouse: 'master-data/warehouse/update/:id',
  ...
  getTransactionById: 'transactions/generaltransaction/history/:id',
...
export default {
  ...
  stockopname: `/${rootPaths.stockopname}`,
  createStockopname: `/${rootPaths.createStockopname}`,
  updateStockopname: `/${rootPaths.updateStockopname}`,
